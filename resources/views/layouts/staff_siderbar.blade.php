    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="">
                    <a href="/staff_routine" class="" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Routine</a>
                </li>
                {{--<li class="">--}}
                    {{--<a href="/add_student" class="" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Class Teacher</a>--}}
                ...
                <li class="">
                    <a href="/staff_view_events" class="" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Events</a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </nav>

                    ...
                    <div class="col-md-12">
                        ...
                        <section class="card">
                            <div class="twt-feed blue-bg">
                                ...
                                <div class="media">
                                    <a href="#">
                                        <img class="align-self-center rounded-circle mr-3" style="width:100px; height:100px;" alt="" src="{{ asset('images/staff_profile/')}}/{{ $profile->image }}">
                                    </a>
                                    <div class="media-body">
                                        <h2 class="text-white display-6">{{ Auth::user()->name }}</h2>
                                        <p class="text-light">Staff ID : {{ Auth::user()->email }}</p>
                                    </div>
                                </div>
                            ...
                            <footer class="twt-footer" style="text-align: right;">
                                <a href="{{route('staff_profile.edit', $profile->id)}}"
                                   class="">
                    ...
                    <section class="card">
                        <div class="twt-feed blue-bg">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h2 class="text-white display-6">{{ Auth::user()->name }}</h2>
                                    <p class="text-light">Teacher ID : {{ Auth::user()->email }}</p>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding:20px;">
                    <form class="form-horizontal" method="POST" action="{{route('staff_profile.store')}}" enctype="multipart/form-data">
